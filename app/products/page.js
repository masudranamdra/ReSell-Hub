          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {products.map((product) => (
                <div
                  key={product._id}
                  className="group bg-white dark:bg-gray-800 border border-slate-200/80 dark:border-gray-700/80 rounded-3xl shadow-md hover:shadow-xl transition-all duration-350 flex flex-col justify-between overflow-hidden relative min-h-[460px] text-left"
                >
                  {/* Image & Badge Cover */}
                  ...
                  <div className="p-4 flex-grow flex flex-col justify-between">
                    ...
                    <div className="border-t pt-3 border-slate-100 dark:border-gray-700 space-y-2">
