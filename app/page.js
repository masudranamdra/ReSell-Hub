            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {featured.length > 0 ? (
                featured.slice(0, 6).map((product) => (
                  <div
                    key={product._id}
                    className="group bg-white dark:bg-gray-800 border border-slate-200/80 dark:border-gray-700/80 rounded-3xl shadow-md hover:shadow-xl transition-all duration-350 flex flex-col justify-between overflow-hidden relative min-h-[580px]"
                  >
                    {/* Image and Badges */}
                    ...
                    <div className="p-5 flex-grow flex flex-col justify-between space-y-4">
                      <div className="space-y-3">
                        ...
                        {(product.brand || product.model) && (
                          <div className="flex gap-2 text-[11px] font-semibold text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-gray-800/40 p-2 rounded-xl">
                        ...
                        {product.features && product.features.length > 0 && (
                          <div className="flex flex-wrap gap-1">
                            {product.features.slice(0, 3).map((feat, i) => (
                              <span key={i} className="bg-slate-100 dark:bg-gray-800 text-slate-650 dark:text-gray-400 px-2 py-0.5 rounded text-[9px] font-bold">
                                # {feat}
                              </span>
                            ))}
                          </div>
                      ...
                      {/* Footer info */}
                      <div className="border-t border-slate-100 dark:border-gray-700 pt-3 space-y-3">
